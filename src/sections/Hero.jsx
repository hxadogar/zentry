...
export default function Hero() {
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      {isLoading && (
        <div className="absolute w-screen h-dvh flex-center z-[100] overflow-hidden bg-yellow-300">
      ...
      >
        <div>
          ...
          <video
            ...
            muted
            id="next-video"
            className="absolute left-0 top-0 size-full z-20 object-cover object-center"
            onLoadedData={handleVideoLoad}
          ></video>
        </div>
